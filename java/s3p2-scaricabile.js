...
function changeBackColor () {
    let backColor = docunt.body;
    backColor.style.changeBackColor = "black";
}

// ESERCIZIO 9: Scrivi una funzione per cambiare l'indirizzo presente nel futuro in un altro, fittizio

function changeAddress () {
    let shopAdd = document.getElementById ("address");
    shopAdd.innerText = "piazza 5 giornate, 30 - 20145 Milano";
}
...
function changePriceColor () {
    ...
    for (let i = 0; 1 <= price.length; i++) {
        price[0],style.color = "blue";
        price[1],style.color = "red";
        price[2],style.color = "brown";
        price[3],style.color = "purple";
        price[4],style.color = "yellow";
        price[5],style.color = "green";
    }
}
